...
public class Utils {
    ...
    public Cmyk rgbToCmyk(Rgb rgbColor) {
        ...
        if (black == 255) {
            ...
            cmykColor = new Cmyk(
                    ((255 - rgbColor.getRed() - black) / (255 - black)),
                    ((255 - rgbColor.getGreen() - black) / (255 - black)),
                    ((255 - rgbColor.getBlue() - black) / (255 - black)),
                    black);
        }
        ...
        if (cmykColor.getBlack() == 255) {
            ...
            rgbColor = new Rgb(((255 - cmykColor.getCyan())
                    * (255 - cmykColor.getBlack()) / 255),
                    ((255 - cmykColor.getMagenta())
                            * (255 - cmykColor.getBlack()) / 255),
                    ((255 - cmykColor.getYellow())
                            * (255 - cmykColor.getBlack()) / 255));
        }
